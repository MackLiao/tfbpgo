-- binding/corr_pair_pearson.sql
-- Per-regulator Pearson correlation between two binding datasets, grouped on
-- (regulator, sample_a, sample_b). Mirrors Shiny's
-- _corr_pair_sql_impl(method="pearson") in
